...
import danube.desktop.xdi.events.XdiTransactionSuccessEvent;
...
public class TransactionEventPanel extends Panel {
	...
	private static final ImageReference IMAGEREFERENCE_SUCCESS = new ResourceImageReference("/danube/desktop/web/resource/image/transactionsuccess.png");
	private static final ImageReference IMAGEREFERENCE_FAILURE = new ResourceImageReference("/danube/desktop/web/resource/image/transactionfailure.png");
