...
public class TransactionEventContentPane extends ContentPane  {
	...
	private void initComponents() {
		...
		ResourceImageReference imageReference1 = new ResourceImageReference(
				"/danube/desktop/web/resource/image/xdi-request.png");
		...
		ResourceImageReference imageReference2 = new ResourceImageReference(
				"/danube/desktop/web/resource/image/xdi-response.png");
		...
		ResourceImageReference imageReference3 = new ResourceImageReference(
				"/danube/desktop/web/resource/image/xdi-exception.png");
