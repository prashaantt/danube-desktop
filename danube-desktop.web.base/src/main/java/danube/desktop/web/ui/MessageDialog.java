...
public class MessageDialog extends WindowPane {
	...
	= new ResourceImageReference("/danube/desktop/web/resource/image/icon/message/message-problem.png");
	public static final ImageReference ICON_INFORMATION
	= new ResourceImageReference("/danube/desktop/web/resource/image/icon/message/message-info.png");
	public static final ImageReference ICON_QUESTION
	= new ResourceImageReference("/danube/desktop/web/resource/image/icon/message/message-question.png");
	public static final ImageReference ICON_WARNING
	= new ResourceImageReference("/danube/desktop/web/resource/image/icon/message/message-warning.png");
	...
	public void show() {
		...
		Component mainContentPane = DesktopApplication.getApp().getDefaultWindow().getContent();
